...
{
    [DbContext(typeof(ItemsFeaturesMigrationsDbContext))]
    [Migration("20210520135651_support multi tenancy")]
    partial class supportmultitenancy
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ItemsFeatures.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ItemsFeatures.CategoriesItems.CategoryItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppCategoriesItems");
                });

            modelBuilder.Entity("ItemsFeatures.Items.Item", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ItemsFeatures.Units.Unit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ItemsFeatures.Categories.Category", b =>
                {
                    b.HasOne("ItemsFeatures.Categories.Category", "ParentCategory")
            ...
            modelBuilder.Entity("ItemsFeatures.CategoriesItems.CategoryItem", b =>
                {
                    b.HasOne("ItemsFeatures.Categories.Category", "Category")
                        .WithMany("CategoriesItems")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ItemsFeatures.Items.Item", "Item")
                        .WithMany("CategoriesItems")
            ...
            modelBuilder.Entity("ItemsFeatures.Items.Item", b =>
                {
                    b.HasOne("ItemsFeatures.Units.Unit", null)
                        .WithMany()
