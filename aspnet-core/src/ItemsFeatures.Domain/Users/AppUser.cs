...
namespace ItemsFeatures.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update ItemsFeaturesDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update ItemsFeaturesEfCoreEntityExtensionMappings to extend the IdentityUser entity
